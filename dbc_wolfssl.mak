...
./Debug/dbc_wolfssl.dxe :$(VDSP)/21k/ldf/ADSP-21060.LDF $(VDSP)/21k/lib/060_hdr.doj ./Debug/dbc_wolfssl.doj ./Debug/error.doj ./Debug/logging.doj ./Debug/misc.doj ./Debug/sha256.doj $(VDSP)/21k/lib/libc.dlb $(VDSP)/21k/lib/libdsp.dlb $(VDSP)/21k/lib/libio.dlb $(VDSP)/21k/lib/libcpp.dlb 
	@echo "Linking..."
	$(VDSP)/cc21k.exe .\Debug\dbc_wolfssl.doj .\Debug\error.doj .\Debug\logging.doj .\Debug\misc.doj .\Debug\sha256.doj -map .\Debug\dbc_wolfssl.map.xml -flags-link -ip -L .\Debug -flags-link -e -add-debug-libpaths -flags-link -od,.\Debug -o .\Debug\dbc_wolfssl.dxe -proc ADSP-21060 -MM

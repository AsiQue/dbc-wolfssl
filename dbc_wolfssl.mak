...
Debug/aes.doj :wolfcrypt/src/aes.c wolfssl/wolfcrypt/settings.h wolfssl/wolfcrypt/visibility.h wolfssl/wolfcrypt/error-crypt.h wolfssl/wolfcrypt/types.h wolfssl/wolfcrypt/wc_port.h $(VDSP)/21k/include/time.h $(VDSP)/21k/include/yvals.h $(VDSP)/21k/include/xcycle_count.h $(VDSP)/21k/include/limits.h $(VDSP)/21k/include/cycle_count_21xxx.h $(VDSP)/21k/include/stdlib.h $(VDSP)/21k/include/string.h $(VDSP)/21k/include/ctype.h wolfssl/wolfcrypt/aes.h wolfssl/wolfcrypt/cpuid.h wolfssl/wolfcrypt/logging.h wolfcrypt/src/misc.c wolfssl/wolfcrypt/misc.h 
	...
	$(VDSP)/cc21k.exe -c .\wolfcrypt\src\aes.c -file-attr ProjectName=dbc_wolfssl -g -structs-do-not-overlap -no-multiline -D NO_MD5 -D NO_SHA -D NO_MD5 -D NO_MD4 -D WOLFCRYPT_ONLY -D SINGLE_THREADED -D NO_FILESYSTEM -D NO_WOLFSSL_MEMORY -D WOLFSSL_HAVE_MIN -D WOLFSSL_HAVE_MAX -D WC_NO_RNG -double-size-32 -warn-protos -proc ADSP-21060 -o .\Debug\aes.doj -MM

Debug/dbc_wolfssl.doj :dbc_wolfssl.c wolfssl/wolfcrypt/aes.h wolfssl/wolfcrypt/types.h wolfssl/wolfcrypt/settings.h wolfssl/wolfcrypt/visibility.h wolfssl/wolfcrypt/wc_port.h $(VDSP)/21k/include/time.h $(VDSP)/21k/include/yvals.h $(VDSP)/21k/include/xcycle_count.h $(VDSP)/21k/include/limits.h $(VDSP)/21k/include/cycle_count_21xxx.h $(VDSP)/21k/include/stdlib.h $(VDSP)/21k/include/string.h $(VDSP)/21k/include/ctype.h 
	@echo ".\dbc_wolfssl.c"
...
./Debug/dbc_wolfssl.dxe :$(VDSP)/21k/ldf/ADSP-21060.LDF $(VDSP)/21k/lib/060_hdr.doj ./Debug/aes.doj ./Debug/dbc_wolfssl.doj ./Debug/error.doj ./Debug/logging.doj ./Debug/misc.doj ./Debug/sha256.doj $(VDSP)/21k/lib/libc.dlb $(VDSP)/21k/lib/libdsp.dlb $(VDSP)/21k/lib/libio.dlb $(VDSP)/21k/lib/libcpp.dlb 
	@echo "Linking..."
	$(VDSP)/cc21k.exe .\Debug\aes.doj .\Debug\dbc_wolfssl.doj .\Debug\error.doj .\Debug\logging.doj .\Debug\misc.doj .\Debug\sha256.doj -map .\Debug\dbc_wolfssl.map.xml -flags-link -ip -L .\Debug -flags-link -e -add-debug-libpaths -flags-link -od,.\Debug -o .\Debug\dbc_wolfssl.dxe -proc ADSP-21060 -MM
